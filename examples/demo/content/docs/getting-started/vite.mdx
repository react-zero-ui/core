---
title: Vite React State Management Setup
description: Set up React Zero-UI in a Vite app for CSS-powered UI state, Tailwind variants, and zero React re-renders.
---
