---
title: Next.js State Management Setup
description: Set up React Zero-UI in a Next.js App Router project for UI state management without providers or extra re-renders.
---
