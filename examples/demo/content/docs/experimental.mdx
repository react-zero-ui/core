...
> **Source Code:** See [experimental](https://github.com/react-zero-ui/core/tree/main/packages/core/src/experimental) for implementation details.
...
[**Get Started in less than 5 minutes**](/docs/getting-started/next)
