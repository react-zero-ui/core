...
export default function Page() {
  ...
  return (
    <div className="mx-auto flex min-h-[100dvh] items-center justify-center border border-gray-200 bg-gray-100 pt-20">
      <div className="mx-auto flex w-full max-w-xl flex-col rounded-lg p-5 shadow-lg">
        ...
        <div className="relative flex overflow-hidden rounded-t-lg border border-gray-200 text-white">
          ...
          <button
            ...
            className="active-zero:text-white relative z-10 flex-1 rounded-tl-lg px-6 py-4 font-semibold text-gray-600 transition-colors duration-300"
          >
            ⚡ React Zero
          </button>
          <button
